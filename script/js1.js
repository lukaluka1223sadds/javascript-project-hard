...
const executeAll1 = [
  {
    ...
    action: async (state) => {
        ...
        try{
            ...
            response = { error: true, message: e.message || "errore a trasferire nell Italy bank" };
        }
  ...
  },
  {
    ...
    action: async (state) => {
        ...
        try{
            ...
            response = { error: true, message: e.message || "みずほフィナンシャルグループへの送金エラー" };
        }
  ...
  },
  {
    ...
    action: async (state) => {
      ...
      try{
        ...
        response = { error: true, message: e.message || "Error transition money in JPMorgan Chase & Co bank"};
      }
